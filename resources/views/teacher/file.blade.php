...
<div class="container">
    <p><a class="btn btn-primary" href="/teacher/filelist/{{ $id }}">Về danh sách</a></p>
    <div class="row">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <form action="/teacher/filestore" name="file" method="post" onsubmit="return validateFile()" enctype="multipart/form-data">
                {{ csrf_field() }}
